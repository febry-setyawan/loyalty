...
/**
 * Standard API response wrapper for all loyalty system endpoints
...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> error(String code, String message, String correlationId) {
        return new ApiResponse<>(false, null, null, new ErrorDetails(code, message, correlationId, null));
    }
    ...
    public static <T> ApiResponse<T> validationError(String message, List<ValidationError> details) {
        return new ApiResponse<>(false, null, null, new ErrorDetails("VALIDATION_ERROR", message, null, details));
    }

    /**
     * Create validation error response with correlation ID
     */
    public static <T> ApiResponse<T> validationError(String message, List<ValidationError> details, String correlationId) {
        return new ApiResponse<>(false, null, null, new ErrorDetails("VALIDATION_ERROR", message, correlationId, details));
    }
    ...
    public static class ErrorDetails {
        ...
        public ErrorDetails(String code, String message, String correlationId, List<ValidationError> details) {
            this.code = code;
            this.message = message;
