 ...
 * Can be extended or customized by individual services as needed
 */
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleLoyaltyException(
        ...
        logger.error("Loyalty exception occurred", 
            "code", ex.getCode(),
    ...
    public ResponseEntity<ApiResponse<Object>> handleValidationException(
        ...
        ApiResponse<Object> response = ApiResponse.validationError(
            "Invalid input data", validationErrors, correlationId);
