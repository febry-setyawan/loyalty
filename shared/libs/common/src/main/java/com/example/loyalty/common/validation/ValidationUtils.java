...
/**
 * Common validation utilities for all services Provides consistent validation logic across the
 * system
 */
@Component
public class ValidationUtils {
  ...
  public static String requireValidPhone(String phone) {
    if (phone != null && !phone.trim().isEmpty() && !isValidPhone(phone)) {
      throw new ValidationException(
          "Invalid phone format. Use international format (+1234567890)", "phone");
    }
