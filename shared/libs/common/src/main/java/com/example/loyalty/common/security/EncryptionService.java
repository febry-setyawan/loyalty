 ...
 * Provides encryption/decryption utilities for PII and sensitive fields
 */
@Service
public class EncryptionService {
    ...
    public EncryptionService(@Value("${app.encryption.key:}") String encryptionKeyBase64) {
        ...
        if (!StringUtils.hasText(encryptionKeyBase64)) {
            throw new IllegalArgumentException("Encryption key must be provided via app.encryption.key property");
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid encryption key format. Must be base64 encoded 256-bit key", e);
        }
    }
