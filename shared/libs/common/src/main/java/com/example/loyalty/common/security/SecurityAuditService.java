 ...
 * Provides audit trail functionality for security events and compliance
 */
@Component
public class SecurityAuditService {
     ...
     */
    public void logPointTransaction(String userId, String transactionType, int points, String result, String reason) {
        SecurityEvent event = SecurityEvent.builder()
     ...
     */
    public void logAdminAction(String adminUserId, String targetUserId, String action, String result, String reason) {
        SecurityEvent event = SecurityEvent.builder()
            .type("ADMIN_ACTION")
            .userId(adminUserId)
            .ipAddress(getClientIpAddress())
