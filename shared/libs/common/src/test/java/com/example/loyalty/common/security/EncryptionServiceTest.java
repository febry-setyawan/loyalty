...
class EncryptionServiceTest {
    ...
    void shouldThrowExceptionForInvalidKey() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new EncryptionService(Base64.getEncoder().encodeToString(new byte[16])); // Wrong size (128 bit instead of 256)
        });
    }
    ...
    void shouldThrowExceptionForInvalidEncryptedData() {
        ...
        assertThrows(SecurityException.class, () -> {
            encryptionService.decryptSensitiveData("dGVzdA=="); // Valid base64 but invalid encryption format
        });
    }
