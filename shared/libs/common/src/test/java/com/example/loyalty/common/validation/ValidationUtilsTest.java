...
class ValidationUtilsTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"password", "Password", "Password1", "PASSWORD!", "Pass1!", "verylongpasswordwithoutuppercasenumbersymbols"})
    ...
    void shouldValidateStringLength() {
        ...
        assertThrows(ValidationException.class, () -> 
            ValidationUtils.requireLength("", "testField", 1, 10));
        assertThrows(ValidationException.class, () -> 
            ValidationUtils.requireLength("verylongstringthatexceedsmaxlength", "testField", 1, 10));
    }
    ...
    void shouldRequirePositiveNumber() {
        ...
        assertThrows(ValidationException.class, () -> 
            ValidationUtils.requirePositive(0, "testField"));
        assertThrows(ValidationException.class, () -> 
            ValidationUtils.requirePositive(-5, "testField"));
    }
    ...
    void shouldRequireValidEmail() {
        ...
        assertThrows(ValidationException.class, () -> 
            ValidationUtils.requireValidEmail(""));
    }
    ...
    void shouldRequireValidPassword() {
        ...
        assertThrows(ValidationException.class, () -> 
            ValidationUtils.requireValidPassword("weak"));
        assertThrows(ValidationException.class, () -> 
            ValidationUtils.requireValidPassword(""));
    }
}